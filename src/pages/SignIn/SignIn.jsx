...
export default function SignIn() {
    ...
    useEffect(() => {
        document.getElementById('Header').style.background = "linear-gradient(to left, #B90D8E, #110A3E)"
        document.getElementById('Header').style.borderRadius = "0px 0px 500px 500px"
    })
    function handleEmailChange(e) { }
    function handlePasswordChange(e) { }
    function signin() {
        loggedIn(true)
        document.getElementById('Header').style.background = "url('Hero.png') linear-gradient(0deg, transparent, transparent)"
        document.getElementById('Header').style.borderRadius = "0px 0px 500px 500px"
    }
    return (<>
        <div className="d-flex flex-column justify-content-center align-items-center signin-form">
            ...
            <form className="d-flex flex-column align-items-center justify-content-center py-2" style={{ margin: "-1rem" }}>
