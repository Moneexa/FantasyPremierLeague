                    ...
                    <div className="d-flex align-items-center justify-content-center flex-wrap">
                        {
                            leagues.map((league, value) => {
                                return (<div key={league.id} className="d-flex flex-column justify-content-center align-items-flex-start div1-stake m-3">
                                    ...
                                    <div className="text-left prize-amount mb-1">{league.prize[2].label}
                                    </div>
