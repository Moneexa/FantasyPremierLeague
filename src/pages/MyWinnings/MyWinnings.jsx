            ...
            <div className="winnings overflow-auto main-padding mt-5">
                ...
                <div className="d-flex flex-column align-items-center tab-1">
                    ...
                    {myWinnings.map((value, index) => {
                        ...
                        <div className="rowText" style={{ width: "35%", minWidth: "8rem" }}>{value.league.league_name} {value.gameweeknumber}</div>
                        <div className="rowText" style={{ width: "15%", minWidth: "8rem" }}>${value.league.value}</div>
                        <div className="rowText" style={{ width: "25%", minWidth: "8rem" }}>{value.rank}</div>
                    </div>)
